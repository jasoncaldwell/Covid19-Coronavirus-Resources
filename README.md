...
* **[DownDog Yoga App](https://www.downdogapp.com/)** So that anyone who wants to practice at home can do so, **we are making all of our apps - Down Dog, Yoga for Beginners, HIIT, Barre, and 7 Minute Workout - completely free until May 1st.** 
  * In response to the many school closures taking place, we are also offering free access until July 1st for all students and teachers (K-12 and college). 
...
*	**[Apple	Card](https://techcrunch.com/2020/03/16/you-can-ask-toskip-your-apple-card-payment-for-march-apple-tells-customers/)**	holders	will	be	allowed	to	skip	their	March	payment	without	incurring	interest	by	
...
Wallet	app	and	ask	to	be	added.	[**Click	here**]	for	more	details
* **[Bank of America](https://about.bankofamerica.com/promo/assistance/latest-updates-from-bank-of-america-coronavirus?cm_sp=EBZ-BAC-Announcement-)** is offering a Credit Card deferral program, along with a number of other options. 
...
* **Discover**: We have support in place for qualified Discover® customers who experience hardship as a result of the outbreak. Please contact our customer service teams as follows:
...
### 🌐 Phone	and	Internet:
*	**[AT&T](https://www.theverge.com/2020/3/12/21177538/att-broadband-internet-data-capcoronavirus-suspend):**	AT&T	is	suspending	broadband	data	caps	for	home	internet	customers.	You	can	read	more	
[**here**].	They’re	also	waiving	late	fees	for	next	30-60	days.	They’ll	also	provide	free	access	
...
households.
*	**[Comcast/Xfinity](https://corporate.comcast.com/covid-19):**	Comcast	opens	Xfinity	WiFi	Network	Nationally	for	Free	and	Offers	Unlimited	
Data	for	Free.	for	more	details
...
### 🌐 Utilities
* **[PG&E](pge.com/covid19consumerprotections)**: We have implemented a series of billing and service modifications to support customers who have been impacted by the pandemic:
  * Suspending service disconnections for non-payment and waiving security deposits.
  * Implementing flexible payment plan options.
  * Providing additional support for low-income and medical baseline customers.

* **[FPL](FPL.com/Help)**: For customers experiencing hardship as a result of COVID-19, we have resources from FPL available to help, and to the extent they are available, we’ll continue to connect customers with resources from federal, state and local authorities. We have also implemented the same policies that we do during major crisis events and are:
  * suspending electrical disconnections, 
  * providing payment extensions and 
...
*	**Enterprise**	will	waive	underage	fees	for	college	students	age	18-24.	[**Here**](https://www.enterprise.com/en/car-rental/deals/young-driver.html)	are	more	details
*  **Hilton** : 
...
* **CVS	and	Walgreens:**	Both	CVS	and	Walgreens	will	[**waive	charges	for	home	delivery**](https://www.forbes.com/sites/brucejapsen/2020/03/12/walgreens-joins-cvs-waiving-drug-deliveryfees-amid-coronavirus-crisis/#7e3d647e51e3) of	prescription	medicines.
...
### 📺 **Entertainment:**
* [**Amazon**](https://www.amazon.com/kindle-dbs/promoLanding?tag=1426-20&promoCode=7cad7d39-c2cf-4e3d-9b17-4ebafbb03a41)	is	offering	2	Months	of	Kindle	Unlimited	for	Free.
*	[**Amazon**](https://amzn.to/2wBiVvq)	is	also	offering	kids	shows	videos	for	free.
* **[NBA League	Pass](https://www.nba.com/nba-fan-letter-league-pass-free-preview)** will	be	offered	for	free	thru	April	22nd.
*	**[NFL	Game	Pass](http://www.nfl.com/news/story/0ap3000001106855/article/nfl-offers-fans-free-access-to-nfl-gamepass)**
will	offer	fans	free	access	to		for	the	next	2	months.
...
#### General Resources
* **[Scholastic](https://classroommagazines.scholastic.com/support/learnathome.html)**	has	setup	a	“learn	from	home”	website	which	will	offer	**free**	daily	courses	for	kids	
stuck	at	home	because	of	school	cancellations.
...
*	[**Brainpop**](https://go.brainpop.com/COVID19)	for	30	days	that	will	be	extended	as	long	as	
...
#### Math
*	**[Prodigy	Math](https://www.prodigygame.com/)**	has	free	video	game	style	math	learning	and	questions.
*	**[MathScore](http://www.mathscore.com/)**	Practice counting to algebra	and	geometry.
...
*	[**The	San	Diego Zoo**](https://kids.sandiegozoo.org/)	has	a	website	just	for	kids	with	amazing	videos,	activities,	and	games.	Enjoy	the	
tour!
...
*	Vocabulary,	grammar,	listening	activities	and	games	in	Spanish,	French,	Italian,	German,	Portuguese,	
...
*	Math	Videos	with	lessons,	real	life	uses	of	math,	famous	actors	[https://www.hmhco.com/math-atwork](https://www.hmhco.com/math-at-work)
...
[https://www.positivephysics.org/home](https://www.positivephysics.org/home)
...
other	documents.	It’s	a	unique	way	to	help	them	learn	about	history.
...
theory.	[https://trainer.thetamusic.com/en](https://trainer.thetamusic.com/en)
...
(https://drive.google.com/drive/u/0/folders/1hCIG-PgDCvlpqPiHAmpxsOHP8KMDMPlg)
